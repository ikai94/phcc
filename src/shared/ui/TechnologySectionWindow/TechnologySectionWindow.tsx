...
export const TechnologySectionWindow = (
    props: TechnologySectionWindowProps,
) => {
    ...
    return (
        <div className={clsx(cls.TechnologySectionWindow, className)}>
            <img
                ...
                width={width}
            />
            <h3 className={cls.TechnologySectionWindow__title}>{title}</h3>
            <p className={cls.TechnologySectionWindow__paragraph}>{text}</p>
        </div>
    );
};
