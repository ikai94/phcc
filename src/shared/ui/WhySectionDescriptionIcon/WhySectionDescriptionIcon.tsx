...
export const WhySectionDescriptionIcon = (
    props: WhySectionDescriptionIconProps,
) => {
    ...
    return (
        <div className={clsx(cls.WhySectionDescriptionIcon, className)}>
            ...
            <div className={cls.WhySectionDescriptionIcon__paragraph}>
                <h3 className={cls.WhySectionDescriptionIcon__title}>
                    {title}
                </h3>
                <p className={cls.WhySectionDescriptionIcon__text}>{text}</p>
            </div>
        </div>
    );
};
