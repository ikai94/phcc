...
export const mainAdvantagesObj: IMainAdvantagesContent = {
    mainAdvantagesContentTop: [
        { text: 'Выгодное месторасположение', src: ClarityMapLine, alt: 'clarity_map-line' },
        { text: 'Охраняемая территория', src: ProtectionIcon, alt: 'protection-icon' },
        { text: 'Городок по периметру ограждён 3-метровым забором', src: Fence, alt: 'fence' },
        { text: 'Здесь вы почувствуете уединенность, безопасностьи комфорт', src: SofaIcon, alt: 'sofa' },
    ],
    mainAdvantagesContentBottom: [
        { text: 'Индивидуальные участки ограждены 2-метровыми заборами', src: HouseIcon, alt: 'house' },
