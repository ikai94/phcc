    ...
    return (
        <div className={clsx(cls.LocationContent, className)}>
                <div className={cls.LocationContent__leftContent}>
                    <h3 className={cls.LocationContentTitle}>
                        Локация
                    </h3>
                    <p className={cls.LocationContentParagraph}>
                        Закрытый коттеджный городок Nura Elite
                        расположен в элитном и перспективном районе
                        столицы, рядом с зелёным поясом по соседству
                        с Vella Village.
                        <br/>
                        <br/>
                        Nura Elite - это прекрасное пространство для
                        уединения и активной семейной жизни в
                        гармонии с природой, без городского шума с
                ...
                <div className={cls.LocationContent__rightContent}>
                    ...
                    <div
                        className={cls.LocationContentImage2}
                    >
                        <img
                    ...
                    <div
                        className={cls.LocationContentImage3}
                    >
                        <img
